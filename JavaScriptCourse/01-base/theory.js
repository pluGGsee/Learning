...
// Делегирование событий это способ создания обработчиков событий для элементов дочерних элементов,
// которые еще не созданы в момент создания обработчика событий.
